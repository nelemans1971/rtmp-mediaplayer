...
namespace Red5Test
{
    ...
    public class CircularBlockBuffer
    {
        ...
        private void GrowBuffer(long newSize)
        {
            ...
            int newBlockCount = Convert.ToInt32(Math.Ceiling((double)newSize / BLOCKSIZE));
        ...
        {
            return Convert.ToInt32(Math.Floor((double)p / BLOCKSIZE));
        }
        ...
        public bool Write(byte[] buffer, int count)
        {
            ...
            {
                Console.WriteLine(string.Format("[CDR.LibRTMP.Media.CircularBlockBuffer.Write]: {0}", e.ToString()));
            }
        ...
        public int Read(byte[] buffer, int count)
        {
            ...
            {
                Console.WriteLine(string.Format("[CDR.LibRTMP.Media.CircularBlockBuffer.Read]: {0}", e.ToString()));
            }
